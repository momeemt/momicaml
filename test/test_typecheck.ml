...
let () =
  Alcotest.run "Momicaml.Typecheck"
    [
      ( "tcheck",
        [
          Alcotest.test_case "test_typecheck_successful" `Quick test_typecheck_successful;
          Alcotest.test_case "test_typecheck_failed" `Quick test_typecheck_failed;
          Alcotest.test_case "test_typecheck_eq_int" `Quick test_typecheck_eq_int;
          Alcotest.test_case "test_typecheck_eq_bool" `Quick test_typecheck_eq_bool;
          Alcotest.test_case "test_typecheck_eq_failed" `Quick test_typecheck_failed;
        ] );
    ]
