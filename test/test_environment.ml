...
let () =
  Alcotest.run "Momicaml.environment"
    [
      ( "Environment.lookup",
        [
          Alcotest.test_case "lookup_single" `Quick
            test_lookup_single_item_environment;
          Alcotest.test_case "lookup_multiple" `Quick
            test_lookup_multiple_items_environment;
          Alcotest.test_case "lookup_duplicate" `Quick
            test_lookup_duplicate_items_environment;
        ] );
    ]
